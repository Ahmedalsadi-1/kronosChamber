...
const ANTIGRAVITY_ACCOUNTS_PATHS = [
  path.join(KRONOSCODE_CONFIG_DIR, 'antigravity-accounts.json'),
  path.join(KRONOSCODE_DATA_DIR, 'antigravity-accounts.json'),
];
...
// ref: https://github.com/opgginc/kronoscode-bar
